...
@statement_type_values = (0..1);
@read_from_type_values = (0..1);
@pointer_type_values = (0..1);
@neighbor_index_type_values = (0..2);
@fma_ins_type_values = (0..1);
@prefetch_index_type_values = (0..1);
@prefetch_distance_values = (0..1);
@rb_size_values = (0..1);
		...
		foreach $log2_nreals_y (@log2_nreals_y_values) {
			...
			foreach $log2_nreals_z (@log2_nreals_z_values) {
				...
				foreach $log2_numThreads (@log2_numThreads_values) {
					...
					my $output_file = ("./" . $platform . "_" . $compiler . "_specified_mpi_3D_" . $nreals_x . "_" . $nreals_y . "_" . $nreals_z . "_" . $numIter . "i_" . $numThreads . "t.txt");
