...
$specified_data_script = ("specified_27pt_cse_data_generator.pl");
...
$greedy_data_script = ("greedy_27pt_cse_data_generator.pl");
...
$random_data_script = ("random_27pt_cse_data_generator.pl");
...
sub generate_specified_data_script {
    ...
    print OUT ("\@log2_numCoreBlockCells_z_values = (4..8)\;\n");
...
sub generate_greedy_data_script {
    ...
    print OUT ("\t\$padding_line_number = \$my_best_timing_line_number - 21\;\n\n");
    print OUT ("\twhile (<TXT>) {\n");
    ...
    print OUT ("\tmy(\$my_file_name, \$my_best_timing_line_number) = \@_;\n\n");
    print OUT ("\topen (TXT, \"\$my_file_name\");\n");
    print OUT ("\t\$core_block_line_number = \$my_best_timing_line_number - 19;\n");
    ...
    print OUT ("\t\t\t\t\tmy \$output_file = (\"./\" . \$platform . \"_\" . \$compiler . \"_greedy\${opt_sweep_number}_27pt_cse_\" . \$nreals_x . \"_\" . \$nreals_y . \"_\" . \$nreals_z . \"_\" . \$numIter . \"i_\" . \$numThreads . \"t.txt\");\n");
    ...
    print OUT ("\t\t\t\t\t\# PADDING\n");
    print OUT ("\t\t\t\t\tforeach \$padding (\@padding_values) {\n");
    print OUT ("\t\t\t\t\t\tsystem (\"\$exec_file \$numIter \$nreals_x \$nreals_y \$nreals_z \$numThreads \$padding \$init_numCoreBlockCells_x \$init_numCoreBlockCells_y \$init_numCoreBlockCells_z \$init_numCoreBlocksPerChunk 0 0 0 \$init_read_from_type_value \$init_pointer_type_value \$init_neighbor_index_type_value 0 \$init_prefetch_index_type_value \$init_prefetch_distance_value \$init_rb_size_value >> \$output_file\");\n");
    print OUT ("\t\t\t\t\t}\n");
    ...
    print OUT ("\t\t\t\t\t\t\t\tforeach \$log2_numCoreBlocksPerChunk (\@log2_numCoreBlocksPerChunk_values) {\n");
    print OUT ("\t\t\t\t\t\t\t\t\tmy \$numCoreBlocksPerChunk = 2**(\$log2_numCoreBlocksPerChunk);\n");
    print OUT ("\t\t\t\t\t\t\t\t\tsystem (\"\$exec_file \$numIter \$nreals_x \$nreals_y \$nreals_z \$numThreads \$best_padding_dims[2] \$numCoreBlockCells_x \$numCoreBlockCells_y \$numCoreBlockCells_z \$numCoreBlocksPerChunk 0 0 0 \$init_read_from_type_value \$init_pointer_type_value \$init_neighbor_index_type_value 0 \$init_prefetch_index_type_value \$init_prefetch_distance_value \$init_rb_size_value >> \$output_file\");\n");
    print OUT ("\t\t\t\t\t\t\t\t}\n");
    print OUT ("\t\t\t\t\t\t\t}\n");
    print OUT ("\t\t\t\t\t\t}\n");
    print OUT ("\t\t\t\t\t}\n\n");
    ...
    print OUT ("\t\t\t\t\t\t\tforeach \$neighbor_index_type (\@neighbor_index_type_values) {\n");
    print OUT ("\t\t\t\t\t\t\t\tforeach \$rb_size (\@rb_size_values) {\n");
    print OUT ("\t\t\t\t\t\t\t\t\tsystem (\"\$exec_file \$numIter \$nreals_x \$nreals_y \$nreals_z \$numThreads \$best_padding_dims[2] \$best_core_block_dims[0] \$best_core_block_dims[1] \$best_core_block_dims[2] \$best_chunk_size[0] 0 0 0 \$read_from_type \$pointer_type \$neighbor_index_type 0 \$init_prefetch_index_type_value \$init_prefetch_distance_value \$rb_size >> \$output_file\");\n");
    print OUT ("\t\t\t\t\t\t\t\t}\n");
    print OUT ("\t\t\t\t\t\t\t}\n");
    print OUT ("\t\t\t\t\t\t}\n");
    print OUT ("\t\t\t\t\t}\n");
    ...
    print OUT ("\t\t\t\t\tforeach \$prefetch_index_type (\@prefetch_index_type_values) {\n");
    print OUT ("\t\t\t\t\t\tforeach \$prefetch_distance (\@prefetch_distance_values) {\n");
    print OUT ("\t\t\t\t\t\t\tsystem (\"\$exec_file \$numIter \$nreals_x \$nreals_y \$nreals_z \$numThreads \$best_padding_dims[2] \$best_core_block_dims[0] \$best_core_block_dims[1] \$best_core_block_dims[2] \$best_chunk_size[0] 0 0 0 \$best_read_from_type[0] \$best_pointer_type[0] \$best_neighbor_index_type[0] 0 \$prefetch_index_type \$prefetch_distance \$best_rb_case[0] >> \$output_file\");\n");
    print OUT ("\t\t\t\t\t\t\tsystem (\"\$exec_file \$numIter \$nreals_x \$nreals_y \$nreals_z \$numThreads \$best_padding_dims[2] \$best_core_block_dims[0] \$best_core_block_dims[1] \$best_core_block_dims[2] \$best_chunk_size[0] 0 0 0 \$best_read_from_type[0] \$best_pointer_type[0] \$best_neighbor_index_type[0] 0 \$prefetch_index_type \$prefetch_distance \$best_rb_case[0] >> \$output_file\");\n");
    print OUT ("\t\t\t\t\t\t}\n");
    print OUT ("\t\t\t\t\t}\n");
    print OUT ("\t\t\t\t\t\$best_timing_line_number = find_best_time_for_opt(\$output_file, \$output_file_line_length);\n");
...
sub generate_random_data_script {
    ...
    print OUT ("my \$output_file = (\"./\" . \$platform . \"_\" . \$compiler . \"_random_27pt_cse_\" . \$nreals_x . \"_\" . \$nreals_y . \"_\" . \$nreals_z . \"_\" . \$numIter . \"i.txt\");\n");
