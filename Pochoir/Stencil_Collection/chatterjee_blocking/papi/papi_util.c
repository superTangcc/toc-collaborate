/*
 *  file :  papi_util.c
 *  desc :  Slightly higher-level utilities for using PAPI.
 *
 *  Best viewed with tabstop=4.
 *
 *  $Header: /project/eecs/demmel/d/bebop/cvs_repo/chatterjee_blocking/papi/papi_util.c,v 1.12 2007/11/07 07:19:27 kdatta Exp $
 */
...
/*
 *  print_measurements( event_sets, measurements,
 *                      num_measurements );
 *
...
void print_papi_measurements(PAPI_event_set_wrapper_t* event_sets, double* measurements,
  ...
  PAPI_event_code_to_name((*event_sets).info.event_code, EventName);
  printf("%s = \n", EventName);
  for (i = 0; i < num_measurements; i++) {
    printf( "%g, ", measurements[i] );
  }
  printf("\n");
}
...
/*
 *  $Log: papi_util.c,v $
 *  Revision 1.12  2007/11/07 07:19:27  kdatta
 *  Small cleanup.
 *
 *  Revision 1.11  2007-11-05 02:33:05  kdatta
 *  Some cleanup.
 *
 ...
 *
 *  Revision 1.8  2006/09/06 18:50:02  kdatta
 *  Corrected a small return value print error in papi_util.c .
 *  OB
 *
 *  Revision 1.7  2006/05/10 23:09:52  kdatta
 *  Changed the code slightly to make the papi version 3 case work.
 *
 *  Revision 1.6  2006/05/10 22:26:43  kdatta
