...
OUT_FILE=../results/bassi_f90_naive_dynamic_aliased_${grid_dim}cubed_z${grid_dim}.out
rm $OUT_FILE
...
OUT_FILE=../results/bassi_f90_naive_dynamic_unaliased_${grid_dim}cubed_z${grid_dim}.out
rm $OUT_FILE
...
OUT_FILE=../results/bassi_f90_naive_static_aliased_${grid_dim}cubed_z${grid_dim}.out
rm $OUT_FILE
...
OUT_FILE=../results/bassi_f90_naive_static_unaliased_${grid_dim}cubed_z${grid_dim}.out
rm $OUT_FILE
